...
} from "@/components/data-table/types/index";
import {
  getCoreRowModel,
  getFacetedRowModel,
...
export function useDataTable<TData, TValue>({
  ...
  // const params = {
  //   page: schema.parse({ page: searchParams.get("page") ?? 1 }).page,
  //   per_page: schema.parse({ per_page: searchParams.get("per_page") ?? 10 }).per_page,
